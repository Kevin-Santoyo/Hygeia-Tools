...
export default function FSAConventionalTable1 ({ data, params }) {
  ...
  return (
    <>
      <Table data={newData} columns={columns} params={params} summary="true" sortBy="Claim" sortDirection="asc" type="fsaconventional" tableNum={1} />
...
export function FSAConventionalTable2 ({ params }){
  ...
  return (
    <>
      <Table data={rows} columns={columns} params={params} summary="true" sortBy="Rpt_Pest_Name" sortDirection="asc" type="fsaconventional" tableNum={2} />
...
export function FSAConventionalTable3 ({ params }){
  ...
  return (
    <>
      <Table data={rows} columns={columns} params={params} summary="true" sortBy="Rpt_Pest_Name" sortDirection="asc" type="fsaconventional" tableNum={3}/>
...
export function FSAConventionalTable4 ({ params }){
  ...
  return (
    <>
      <Table data={rows} columns={columns} params={params} summary="true" sortBy="FS_DRI_Kid" sortDirection="desc" type="fsaconventional" tableNum={4}/>
