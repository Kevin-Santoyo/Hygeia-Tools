...
const BarChart1 = ({ data, params }) => {
  return (
    <>
    <p className={styles.title}>Figure 1: Aggregate FS-DRI for {params[0]}, {params[1]}</p>
...
const BarChart2 = ({ data, params }) => {
  return (
    <>
    <p className={styles.title}>Figure 2: Average Number of Pesticide Residues per Sample in {params[0]}, {params[1]}</p>
    <div className={styles.chart}>
      <Bar
        data={data}
        options={{
...
const PieChart1 = ({ data, params }) => {
  return (
    <>
    <p className={styles.title}>Figure 3: {params[0]} Containing Zero Positive Pesticide Residues, {params[1]}</p>
